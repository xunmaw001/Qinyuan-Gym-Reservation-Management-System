...
public class KechengpingjiaController {
    ...
    public R page(@RequestParam Map<String, Object> params,KechengpingjiaEntity kechengpingjia,
		...
		if(tableName.equals("yonghu")) {
			kechengpingjia.setYonghudianhua((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jiaolian")) {
			kechengpingjia.setYuangonghao((String)request.getSession().getAttribute("username"));
		}
