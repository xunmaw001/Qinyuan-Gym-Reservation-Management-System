...
public class KechengyuyueController {
    ...
    public R page(@RequestParam Map<String, Object> params,KechengyuyueEntity kechengyuyue,
		...
		if(tableName.equals("yonghu")) {
			kechengyuyue.setYonghudianhua((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jiaolian")) {
			kechengyuyue.setYuangonghao((String)request.getSession().getAttribute("username"));
		}
