<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="用户电话" prop="yonghudianhua">
          <el-input v-model="ruleForm.yonghudianhua" readonly              placeholder="用户电话" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaolian'"  label="员工号" prop="yuangonghao">
          <el-input v-model="ruleForm.yuangonghao" readonly              placeholder="员工号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaolian'"  label="教练电话" prop="jiaoliandianhua">
          <el-input v-model="ruleForm.jiaoliandianhua"               placeholder="教练电话" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      if((!this.ruleForm.yonghudianhua)&& 'yonghu'==this.flag){
      ...
      if((!this.ruleForm.yuangonghao)&& 'jiaolian'==this.flag){
      ...
      if( 'jiaolian' ==this.flag && this.ruleForm.jiaoliandianhua&&(!isMobile(this.ruleForm.jiaoliandianhua))){
