    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="购买账单" prop="goumaizhangdan">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.goumaizhangdan" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.goumaizhangdan" label="购买账单" prop="goumaizhangdan">
                    <span v-html="ruleForm.goumaizhangdan"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  computed: {
    ...
    zongjia:{
      get: function () {
        return 1*this.ruleForm.shuliang*this.ruleForm.goumaijiage
      }
    },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zongjia = true;
          ...
          if(o=='goumaizhangdan'){
            this.ruleForm.goumaizhangdan = obj[o];
	    this.ro.goumaizhangdan = true;
            continue;
          }
        }
	...
	this.ruleForm.goumaizhangdan = this.ruleForm.goumaizhangdan.replace(reg,'../../../springboott94n4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
