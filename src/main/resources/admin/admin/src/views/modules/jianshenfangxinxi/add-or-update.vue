    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="健身项目" prop="jianshenxiangmu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="健身项目"
                  v-model="ruleForm.jianshenxiangmu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianshenxiangmu" label="健身项目" prop="jianshenxiangmu">
                    <span>{{ruleForm.jianshenxiangmu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="健身房简介" prop="jianshenfangjianjie">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jianshenfangjianjie" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianshenfangjianjie" label="健身房简介" prop="jianshenfangjianjie">
                    <span v-html="ruleForm.jianshenfangjianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='jianshenfangjianjie'){
            this.ruleForm.jianshenfangjianjie = obj[o];
	    this.ro.jianshenfangjianjie = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.jianshenfangjianjie = this.ruleForm.jianshenfangjianjie.replace(reg,'../../../springboott94n4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jianshenfangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jianshenfangxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
