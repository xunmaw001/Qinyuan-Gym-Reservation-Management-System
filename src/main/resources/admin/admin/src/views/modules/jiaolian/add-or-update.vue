<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教练电话" prop="jiaoliandianhua">
          <el-input v-model="ruleForm.jiaoliandianhua" 
              placeholder="教练电话" clearable  :readonly="ro.jiaoliandianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教练电话" prop="jiaoliandianhua">
              <el-input v-model="ruleForm.jiaoliandianhua" 
                placeholder="教练电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='jiaoliandianhua'){
            this.ruleForm.jiaoliandianhua = obj[o];
	    this.ro.jiaoliandianhua = true;
            continue;
          }
          if(o=='touxiang'){
