    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="评价内容" prop="pingjianeirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.pingjianeirong" label="评价内容" prop="pingjianeirong">
                    <span v-html="ruleForm.pingjianeirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.pingjianeirong = this.ruleForm.pingjianeirong.replace(reg,'../../../springboott94n4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `kechengpingjia/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.kechengpingjiaCrossAddOrUpdateFlag = false;
						 this.parent.search();
