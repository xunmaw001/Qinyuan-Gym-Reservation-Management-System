<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="取消编号" prop="quxiaobianhao">
            <el-input v-model="ruleForm.quxiaobianhao" 
                placeholder="取消编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.quxiaobianhao" label="取消编号" prop="quxiaobianhao">
              <el-input v-model="ruleForm.quxiaobianhao" 
                placeholder="取消编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用户电话" prop="yonghudianhua">
          <el-input v-model="ruleForm.yonghudianhua" 
              placeholder="用户电话" clearable  :readonly="ro.yonghudianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用户电话" prop="yonghudianhua">
              <el-input v-model="ruleForm.yonghudianhua" 
                placeholder="用户电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="取消事由" prop="quxiaoshiyou">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.quxiaoshiyou" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.quxiaoshiyou" label="取消事由" prop="quxiaoshiyou">
                    <span v-html="ruleForm.quxiaoshiyou"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.quxiaoshijian = true;
          ...
          if(o=='quxiaoshiyou'){
            this.ruleForm.quxiaoshiyou = obj[o];
	    this.ro.quxiaoshiyou = true;
            continue;
          }
          if(o=='yonghudianhua'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.yonghudianhua!=''&&json.yonghudianhua){
	...
	this.ruleForm.quxiaoshiyou = this.ruleForm.quxiaoshiyou.replace(reg,'../../../springboott94n4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `kechengquxiao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.kechengquxiaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
