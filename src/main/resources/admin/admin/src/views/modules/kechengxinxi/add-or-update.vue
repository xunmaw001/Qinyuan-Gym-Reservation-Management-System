<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所需器材" prop="suoxuqicai">
          <el-input v-model="ruleForm.suoxuqicai" 
              placeholder="所需器材" clearable  :readonly="ro.suoxuqicai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所需器材" prop="suoxuqicai">
              <el-input v-model="ruleForm.suoxuqicai" 
                placeholder="所需器材" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="开课状态" prop="kaikezhuangtai">
          <el-select :disabled="ro.kaikezhuangtai" v-model="ruleForm.kaikezhuangtai" placeholder="请选择开课状态">
            <el-option
                v-for="(item,index) in kaikezhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="开课状态" prop="kaikezhuangtai">
	      <el-input v-model="ruleForm.kaikezhuangtai"
                placeholder="开课状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.kechengxiangqing" label="课程详情" prop="kechengxiangqing">
                    <span v-html="ruleForm.kechengxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiage = true;
          ...
          if(o=='suoxuqicai'){
            this.ruleForm.suoxuqicai = obj[o];
	    this.ro.suoxuqicai = true;
            continue;
          }
	    ...
	    this.ro.jiaolianxingming = true;
          ...
          if(o=='kaikezhuangtai'){
            this.ruleForm.kaikezhuangtai = obj[o];
	    this.ro.kaikezhuangtai = true;
            continue;
          }
          if(o=='clicktime'){
       ...
       this.ruleForm.kaikezhuangtai='否'
      }
      // 获取用户信息
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.yuangonghao!=''&&json.yuangonghao){
                this.ruleForm.yuangonghao = json.yuangonghao
	    		this.ro.yuangonghao = true;
		}
		...
		if(this.$storage.get("role")!="管理员") {
          ...
          this.$message.error(data.msg);
            ...
            this.kaikezhuangtaiOptions = "是,否".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.kechengxiangqing = this.ruleForm.kechengxiangqing.replace(reg,'../../../springboott94n4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
