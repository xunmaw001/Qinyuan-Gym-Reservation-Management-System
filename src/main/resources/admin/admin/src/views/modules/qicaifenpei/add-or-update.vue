<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="分配编号" prop="fenpeibianhao">
            <el-input v-model="ruleForm.fenpeibianhao" 
                placeholder="分配编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fenpeibianhao" label="分配编号" prop="fenpeibianhao">
              <el-input v-model="ruleForm.fenpeibianhao" 
                placeholder="分配编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="器材名称" prop="qicaimingcheng">
          <el-input v-model="ruleForm.qicaimingcheng" 
              placeholder="器材名称" clearable  :readonly="ro.qicaimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="器材名称" prop="qicaimingcheng">
              <el-input v-model="ruleForm.qicaimingcheng" 
                placeholder="器材名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="课程标题" prop="kechengbiaoti">
          <el-select :disabled="ro.kechengbiaoti" @change="kechengbiaotiChange" v-model="ruleForm.kechengbiaoti" placeholder="请选择课程标题">
            <el-option
                v-for="(item,index) in kechengbiaotiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.kechengbiaoti" label="课程标题" prop="kechengbiaoti">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="员工号" prop="yuangonghao">
          <el-input v-model="ruleForm.yuangonghao" 
              placeholder="员工号" clearable  :readonly="ro.yuangonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="员工号" prop="yuangonghao">
              <el-input v-model="ruleForm.yuangonghao" 
                placeholder="员工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="分配详情" prop="fenpeixiangqing">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="分配详情"
                  v-model="ruleForm.fenpeixiangqing" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fenpeixiangqing" label="分配详情" prop="fenpeixiangqing">
                    <span>{{ruleForm.fenpeixiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	fenpeixiangqing : false,
      },
      ruleForm: {
        fenpeibianhao: this.getUUID(),
        qicaimingcheng: '',
        shuliang: '',
        fenpeishijian: '',
        kechengbiaoti: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='fenpeibianhao'){
            this.ruleForm.fenpeibianhao = obj[o];
	    this.ro.fenpeibianhao = true;
            continue;
          }
          if(o=='qicaimingcheng'){
	    ...
	    this.ro.kechengfenlei = true;
          ...
          if(o=='yuangonghao'){
            this.ruleForm.yuangonghao = obj[o];
	    this.ro.yuangonghao = true;
            continue;
          }
	    ...
	    this.ro.jiaolianxingming = true;
          ...
          if(o=='fenpeixiangqing'){
            this.ruleForm.fenpeixiangqing = obj[o];
	    this.ro.fenpeixiangqing = true;
            continue;
          }
        }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/kechengxinxi/kechengbiaoti`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.kechengbiaotiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    kechengbiaotiChange () {
      this.$http({
        url: `follow/kechengxinxi/kechengbiaoti?columnValue=`+ this.ruleForm.kechengbiaoti,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.kechengfenlei){
                this.ruleForm.kechengfenlei = data.data.kechengfenlei
              }
              if(data.data.yuangonghao){
                this.ruleForm.yuangonghao = data.data.yuangonghao
              }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `qicaifenpei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.qicaifenpeiCrossAddOrUpdateFlag = false;
						 this.parent.search();
