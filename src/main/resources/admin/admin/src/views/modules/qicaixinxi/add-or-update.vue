<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="器材编号" prop="qicaibianhao">
            <el-input v-model="ruleForm.qicaibianhao" 
                placeholder="器材编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qicaibianhao" label="器材编号" prop="qicaibianhao">
              <el-input v-model="ruleForm.qicaibianhao" 
                placeholder="器材编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="器材用途" prop="qicaiyongtu">
          <el-input v-model="ruleForm.qicaiyongtu" 
              placeholder="器材用途" clearable  :readonly="ro.qicaiyongtu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="器材用途" prop="qicaiyongtu">
              <el-input v-model="ruleForm.qicaiyongtu" 
                placeholder="器材用途" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="器材详情" prop="qicaixiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.qicaixiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qicaixiangqing" label="器材详情" prop="qicaixiangqing">
                    <span v-html="ruleForm.qicaixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='qicaiyongtu'){
            this.ruleForm.qicaiyongtu = obj[o];
	    this.ro.qicaiyongtu = true;
            continue;
          }
          if(o=='shuliang'){
	    ...
	    this.ro.shuliang = true;
          ...
          if(o=='qicaixiangqing'){
            this.ruleForm.qicaixiangqing = obj[o];
	    this.ro.qicaixiangqing = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.qicaixiangqing = this.ruleForm.qicaixiangqing.replace(reg,'../../../springboott94n4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `qicaixinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.qicaixinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
